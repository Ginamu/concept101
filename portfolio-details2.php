...
<body>
   ...
   <section id="maincontent">
    <div class="container">
      <div class="row">
        <div class="span12" id="portfolio1">
          <article>
            <div class="heading">
              <h3><strong>Iamwanjohi</strong></h3>
            </div>
            <div class="clearfix">
            </div>
            <div class="row">
              <div class="span8">
                ...
                <div class="flexslider">
                  <ul class="slides">
                    <li>
                      <img src="concept/pics/jichoche1.png" alt="" />
                    </li>
                    <li>
                      <img src="concept/pics/jichoche2.png" alt="" />
                    </li>
                    <li>
                      <img src="concept/pics/jichoche3.png" alt="" />
                    </li>
                  </ul>
                </div>
                <!-- end flexslider -->
                ...
                <aside>
                  <div class="widget">
                    ...
                    <ul class="project-detail">
                      <li><label>Project name :</label> Photography Website</li>
                      <li><label>Category :</label> Web design</li>
                      <li><label>Project date :</label> 12 January 2018</li>
                      <li><label>Project link :</label><a href="#">www.Iamwanjohi.com</a></li>
                    </ul>
                  </div>
                </aside>
              </div>
