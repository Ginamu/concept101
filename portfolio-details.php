    ...
    <div class="container">
      <div class="row">
        <div class="span12" id="portfolio1">
          <article>
            <div class="heading">
              <h3><strong>Fivestar essays</strong></h3>
            </div>
            <div class="clearfix">
            </div>
            <div class="row">
              <div class="span8">
                ...
                <div class="flexslider">
                  <ul class="slides">
                    <li>
                      <img src="concept/pics/essay1.png" alt="" />
                    </li>
                    <li>
                      <img src="concept/pics/essay2.png" alt="" />
                    </li>
                    <li>
                      <img src="concept/pics/essay3.png" alt="" />
                    </li>
                  </ul>
                </div>
                <!-- end flexslider -->
                ...
                <aside>
                  <div class="widget">
                    ...
                    <ul class="project-detail">
                      <li><label>Project name :</label> Fivestar essays</li>
                      <li><label>Category :</label> Web design</li>
                      <li><label>Project date :</label> 12 October 2017</li>
                      <li><label>Project link :</label><a href="#">www.fivestaressays.com</a></li>
                    </ul>
                  </div>
                </aside>
              </div>
