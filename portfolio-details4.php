...
<body>
   ...
   <section id="maincontent">
    <div class="container">
      <div class="row">
        <div class="span12" id="portfolio4">
          <article>
            <div class="heading">
              <h3><strong>Fumlee</strong></h3>
            </div>
            <div class="clearfix">
            </div>
            <div class="row">
              <div class="span8">
                ...
                <div class="flexslider">
                  <ul class="slides">
                    <li>
                      <img src="concept/pics/wololo1.png" alt="" />
                    </li>
                    <li>
                      <img src="concept/pics/wololo2.png" alt="" />
                    </li>
                    <li>
                      <img src="concept/pics/wololo3.png" alt="" />
                    </li>
                  </ul>
                </div>
                <!-- end flexslider -->
                ...
                <aside>
                  <div class="widget">
                    ...
                    <ul class="project-detail">
                      <li><label>Project name :</label> Fumlee online shopping</li>
                      <li><label>Category :</label> Web E-commerce </li>
                      <li><label>Project date :</label>12 June 2018</li>
                      <li><label>Project link :</label><a href="#">coming soon</a></li>
                    </ul>
                  </div>
                </aside>
              </div>
